...
public class AdapterBaiHat extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View row = inflater.inflate(R.layout.hoai_row_baihat,null);
        ...
        btnSua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context , HoaiUpdateActivity.class);
    ...
    private void delete(int idsong){
        ...
        database.delete("VanDinhHoai_BaiHat"," ID = ?", new String[] {idsong+""});
