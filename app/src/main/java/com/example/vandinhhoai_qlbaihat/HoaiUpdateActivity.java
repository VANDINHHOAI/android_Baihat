...
public class HoaiUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hoai_update);
    ...
    private void addEvent() {
        ...
        btnHuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HoaiUpdateActivity.this, HoaiMainActivity.class);
    ...
    private void update() {
        ...
        database = Database.initDatabase(HoaiUpdateActivity.this, DATABASE_NAME);
        database.update("VanDinhHoai_BaiHat", contentValues, " ID = ?", new String[] {idBH + ""});
